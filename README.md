...
\newpage
## Настройка задач
* /cron?key=123 - для обновления информации о серверах : раз в 5 минут
* /cron/pay?key=123 - для проверки платных услуг на серверах раз в час
* /cron/tasks?=key=123 - для проверки системных задач раз в день
* /cron/qiwi?key=123 - для проверки платежей: раз 1 минуту
* /cron/payments?key=123 - для проверки просроченных счетов: раз в час - для проверки системных задач раз в день
