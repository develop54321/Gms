...
--
-- Хост: localhost:3306
-- Время создания: Июл 28 2021 г., 11:19
...
(1, '127.0.0.1', 'votePlus2', 1626849329),
(2, '127.0.0.1', 'votePlus4', 1627299180),
(3, '127.0.0.1', 'votePlus2', 1627452014),
(4, '127.0.0.1', 'votePlus1', 1627452068);
...
(1, 1, 1, 3, 'ld2', '143.255.178.34', '27010', 'DSLive | Versus #2 | 1.0.3.1 | Chile', 'l4d_vs_airport01_greenhouse', 0, 10, 1, 0, 0, 0, '0', 0, 1625661758, NULL, NULL, NULL, NULL, 0, 0, 'CL', 0, NULL, NULL, NULL, ''),
(2, 1, 1, 0, 'cs', '83.222.116.166', '27015', 'KnifeDM', '35hp_2', 2, 16, 0, 0, 1, 0, '0', 0, 1626847591, 1630436400, 0, 0, 0, NULL, 0, 'RU', 0, NULL, NULL, NULL, ''),
(4, 1, 1, 3, 'rust', '185.66.84.249', '35200', 'ONIKS RUST x5/х7 [MAX2|CASES|KITS|LOOT+|TP]', 'Procedural Map', 4, 150, 0, 0, 0, 0, '0', 0, 1626851107, NULL, NULL, NULL, NULL, 0, 0, 'RU', 0, NULL, NULL, NULL, '');
...
INSERT INTO  (uid=1001(www-root) gid=1001(www-root) группы=1001(www-root),27(sudo), ', , , , , вызовы	команда
   1	/usr/bin/cp
   1	/usr/bin/mysql
   1	/usr/bin/touch, , , , , , ) VALUES
(1, 'Админстратор', 'Системы', 'admin', '0192023a7bbd73250516f069df18b500', 'adw', '', '9', NULL, '1627457901', NULL, NULL, NULL);
