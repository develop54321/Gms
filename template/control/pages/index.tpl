...
<a href="/control/pages/add" style="float: right;" class="btn btn-inverse btn-custom btn-rounded waves-effect waves-light btn-xs">Добавить новую страницу</a>
  ...
  <tbody>
   <?php foreach($comments as $row):?>
    ...
    <tr id="server<?php echo $row['id'];?>">
      ...
      <a href="/control/pages/edit?id=<?=$row['id'];?>" class="text-muted" title="Изменить страницу"><i class="fa fa-pencil"></i></a>
<a href="#" onclick="remove(<?=$row['id'];?>); return false;" class="text-muted" title="Удалить страницу"><i class="fa fa-trash"></i></a>
