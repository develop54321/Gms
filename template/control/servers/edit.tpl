...
<div class="form-group">
<label for="rating">Сервер в бане?</label>
...
<div class="form-group">
<label for="vip_enabled">Время истечения</label>
...
<input type="number" class="form-control" name="boost" min="0" value="<?php echo $data['boost'];?>">
</div>
