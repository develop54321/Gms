...
<div class="col-sm-12">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select name="status" class="form-control input-sm">
                            ...
                            <option value="0" <?php if ($filter['status'] == '0'): ?>selected<?php endif; ?>>Ожидают
                                проверку
                            </option>
                        </select>
                    </div>
    ...
    <div class="card-box">
        ...
        <p class="text-muted m-b-30 font-12">серверы по умолчанию сортируется по дате добавления</p>
