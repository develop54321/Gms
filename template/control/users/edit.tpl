...
<li><a href="/control/users">Пользователи</a></li>
...
<div class="col-sm-12">
<div class="card-box">
<h4 class="m-t-0 header-title"><b>Изменение пользователя</b></h4>
...
<option value="admin" <?php if($data['role'] == 'admin'):?>selected=""<?php endif;?>>Администратор</option>
<option value="partner" <?php if($data['role'] == 'partner'):?>selected=""<?php endif;?>>Партнер</option>
<option value="banned" <?php if($data['role'] == 'banned'):?>selected=""<?php endif;?>>Заблокирован</option>
</select>
</div>
...
<input type="number" name="api[discount]" class="form-control" value="<?php echo $api_params['discount_api'];?>">
</div>
</div>
</div>
