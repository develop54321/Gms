...
<?php if($settings['global_settings']['top_on']==1):?>
    <tr>
        ...
        <td class="text-center"><?php echo $free_servers_top;?> из <?php echo $settings['global_settings']['count_servers_top'];?></td>
...
<?php if($settings['global_settings']['boost_on']==1):?>
    <tr>
        ...
        <td class="text-center"><?php echo $free_servers_boost;?> из <?php echo $settings['global_settings']['count_servers_boost'];?></td>
...
<?php if($settings['global_settings']['vip_on']==1):?>
    <tr>
        ...
        <td class="text-center"><?php echo $free_servers_vip;?> из <?php echo $settings['global_settings']['count_servers_vip'];?></td>
...
<?php if($settings['global_settings']['color_on']==1):?>
	<tr>
        ...
        <td class="text-center"><?php echo $free_servers_color;?> из <?php echo $settings['global_settings']['count_servers_color'];?></td>
