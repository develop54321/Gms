            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item"><b>Ваш счет:</b> <?php echo \widgets\money\Money::run($user_profile['balance']); ?> [<a href="/user/pay" style="color: #0078b1;">Пополнить</a>]
                        </li>
                        ...
                        <?php if ($user_profile['role'] == 'partner'): ?>
                            <li class="list-group-item"><b>Размер скидки:</b><?php echo $user_profile['discount_api']; ?>%
                            </li>
