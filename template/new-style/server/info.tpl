<section class="content mt-5 server-info">
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/">Главная</a></li>
                <li class="breadcrumb-item active" aria-current="page">Информация о сервере
                    - <?php echo $data['hostname'];?></li>
            </ol>
        </nav>
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <table class="table">
                    ...
                    <tr>
                        <td>
                            Будь Первым - место #<?php echo $data['befirst_enabled'];?> | Оплачено
                            до: <?php echo date("d.m.Y [H:i]", $data['befirst_expired_date']);?>
                        </td>
                    </tr>
                    <?php endif;?>
