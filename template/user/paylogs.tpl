  ...
  <tbody>
   <?php foreach($data as $row):?>
    ...
    <tr>
      ...
      <td>
      <?php if($row['type_pay'] == 'payApi'):?><b>[API]</b><?php endif;?> <?php echo $row['servicesName'];?>| 
      <?php if($row['type_pay'] == 'refill'):?>
      id пользователя
      <?php elseif($row['type_pay'] == 'payServices' or $row['type_pay'] == 'payApi'):?>
      id сервера
      <?php endif;?>
      
       #<?php echo $row['id_object'];?></td>
